<template>
  <div>
    ...
    <el-dialog title="旅游路线信息" v-model="data.formVisible" width="80%" destroy-on-close>
      <el-form ref="form" :model="data.form" label-width="70px" style="padding: 20px">
        ...
        <el-form-item prop="longitude" label="经度">
          <div style="width:100% ;display: flex;align-items: center">
            <el-input style="flex:1" v-model="data.form.longitude" placeholder="请输入小经度"></el-input>
            <a style="color: #0066bc" href="https://api.map.baidu.com/lbsapi/getpoint/index.html" target="_blank">查看经纬度</a>
          </div>
        </el-form-item>
    ...
    <el-dialog title="内容预览" v-model="data.formVisibleContent" width="80%" destroy-on-close>
